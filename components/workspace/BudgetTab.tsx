...
<body>
  ...
  return (
    ...
    <div ref={budgetRef} className="construsheet-scroll" style={{ display: "flex", flexDirection: "column", gap: 16, padding: "12px 16px", paddingRight: panelOpen ? 408 : 16, transition: "padding-right 200ms ease", width: "100%", overflow: "auto", flex: 1, minHeight: 0 }}>
      {/* ── Header ─────────────────────────────────────────── */}
      ...
      {rows.length > 0 && (
        ...
        <div className="rounded-[10px]" style={{ border: `1px solid ${CS.border}`, overflow: "visible" }}>
          <div>
